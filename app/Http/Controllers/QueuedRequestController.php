...
class QueuedRequestController extends Controller
{
    /**
    ...
    {
        return view('admin.queued.index'); // your request form blade
    }
    ...
    public function getData(Request $request)
    {
        ...
        return response()->json([
            'data' => $requests,
            'recordsTotal' => EmailRequest::where('status', 'queued')->count(),
